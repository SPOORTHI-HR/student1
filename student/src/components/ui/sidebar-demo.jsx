...
import { LayoutDashboard, UserCog, Settings, LogOut, BookOpen, Calendar, ClipboardCheck, FileText } from "lucide-react";
...
import { LearningActivityGraph } from "@/components/ui/learning-activity-graph";
      ...
      <div className="w-full h-full bg-slate-100 rounded-xl shadow-lg flex flex-col overflow-hidden relative">
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden p-3 sm:p-4 md:p-6 relative scrollbar-hide">
          ...
          <div className="hidden lg:block">
            ...
            <div className="absolute left-6 top-[785px] right-[360px] pt-8">
              <LearningActivity />
            </div>
