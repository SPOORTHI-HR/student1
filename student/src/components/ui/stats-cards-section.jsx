  ...
  return (
    <div className="w-full">
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <div className="relative rounded-xl bg-[#60A5FA] p-5 flex-1 min-w-[140px] h-[150px] md:h-[160px] overflow-hidden">
        ...
        <div className="relative rounded-xl bg-[#F6C652] p-5 flex-1 min-w-[140px] h-[150px] md:h-[160px] overflow-hidden">
          {/* Watermark icon - bigger, half showing */}
        ...
        {/* Attendance Card */}
        <div className="relative rounded-xl bg-[#2A3648] p-5 flex-1 min-w-[140px] h-[150px] md:h-[160px] overflow-hidden">
          {/* Watermark icon - bigger, half showing */}
        ...
        {/* Overall Grade Card */}
        <div className="relative rounded-xl bg-[#8B5CF6] p-5 flex-1 min-w-[140px] h-[150px] md:h-[160px] overflow-hidden">
          {/* Watermark icon - bigger, half showing */}
