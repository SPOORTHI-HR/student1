            ...
            <div className="event-page-container flex flex-col gap-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-6">
                  <section className="event-ongoing-section bg-white rounded-xl shadow-sm p-5">
                    <h1 className="event-section-title">Ongoing Class</h1>
                    <div className="event-ongoing-cards">
                      <div className="event-ongoing-card event-card-ui">
                      ...
                      <div className="event-ongoing-card event-card-fullstack">
                        <div className="event-ongoing-header">
                  ...
                  <section className="event-today-section bg-white rounded-xl shadow-sm p-5">
                        ...
                        {scheduleItems.map((item) => (
                          ...
                          >
                            <div className="event-schedule-content">
                              ...
                              <div className="event-schedule-avatars">
                                {item.avatars.map((avatar, index) => (
                                  <img key={index} src={avatar} alt="Participant" />
                                ))}
                              </div>
                            </div>
                          </div>
                ...
                <div className="flex flex-col gap-6">
                  <section className="event-calendar-section bg-white rounded-xl shadow-sm p-5 flex flex-col gap-5">
                  ...
                  <section className="event-upcoming-section bg-white rounded-xl shadow-sm p-5 flex flex-col gap-5">
